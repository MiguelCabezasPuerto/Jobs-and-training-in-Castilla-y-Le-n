 ...
 *
 * Define la estructura de la tabla de ofertas de formacion de la base de datos
 *
 * @author Miguel Cabezas Puerto
 * @version 1.0
 */
public class Estructura_Formacion implements BaseColumns {
    public static final String TABLE_NAME= "ZFormacionNueva";
